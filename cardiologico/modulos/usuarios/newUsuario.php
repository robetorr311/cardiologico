<?php
	...
	$resultado.="<td class=\"formulario\"><input name=\"login\" type=\"text\" class=\"textbox\" id=\"login\" size=\"20\" maxlength=\"8\" ></td>";
	...
	$resultado.="<td class=\"formulario\"><input name=\"password\" type=\"password\" class=\"textbox\" id=\"password\" ></td>";
	...
	$resultado.="<option value=\"xx\">Seleccione</option>";
	...
	$resultado.="<td class=\"formulario\"><input type=\"button\" class=\"button\" name=\"Submit\" value=\"Guardar\" onClick=\"guardarUsuarios()\">";
