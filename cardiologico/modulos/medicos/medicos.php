...
<div id="medicos">
		<form id="formulario">
		  <table width="660" border="1" cellspacing="0">
			<tr>
			  <td width="60" class="titulo_form"><img src="../../Imagenes/fmedicos.png" width="30" height="30"></td>
			  <td width="584" class="titulo_form">Ficha  Ingreso de Medicos</td>
			</tr>
		  </table>
		  <table width="660" border="1" cellspacing="0">
			<tr>
	...
	<div id="sect">
		  ...
		  <table width="660" border="1" cellspacing="0">
			<tr>  
			  <td class="head">Repetir Contraseña</td>
		  ...
		  <table width="660" border="1" cellspacing="0">
			<tr>
			  <td class="formulario"><input type="button" class="button" name="Submit" value="Agregar" onClick="newMedico()">
