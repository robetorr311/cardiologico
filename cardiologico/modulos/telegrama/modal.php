	...
	<form id="modal">
		<table width="400">
			...
			<tr>
					...
					<td class="ayuda"><img src="../../Imagenes/ayuda.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Municipio')"></td>
				</tr>
				<tr>
				...
				<div id="demoDer">
					...
					<td class="ayuda"><img src="../../Imagenes/ayuda.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Parroquia')"></td>
				</tr>
		</table>
