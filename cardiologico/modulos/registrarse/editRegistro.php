<?php
	...
	$resultado.="<td class=\"formulario\"><input type=\"hidden\" id=\"idmedico\" value=\"$id\"><input name=\"cedula\" type=\"text\" class=\"textbox\" id=\"cedula\" size=\"20\" value=\"$cedula\" ></td>";
	...
	$resultado.="<td width=\"248\"><input name=\"edad\" type=\"text\" class=\"textbox\" id=\"edad\" size=\"5\"  value=\"$edad\" ></td>";
	...
	$resultado.="</tr>";
	$resultado.="<tr>";
	$resultado.="<td class=\"formulario\"><textarea name=\"direccion\" class=\"textbox\" id=\"direccion\" >$direccion</textarea></td>";
	...
	$resultado.="<table width=\"660\" border=\"1\" cellspacing=\"0\">";
	$resultado.="<tr>";
	$resultado.="<td class=\"formulario\"><input type=\"button\" class=\"button\" name=\"Submit\" value=\"Guardar\" onClick=\"updateRegistro()\">";
