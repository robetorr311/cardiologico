...
function updateRegistro(){
	...
	if(med==1){
		...
		ajax.open("POST","updateRegistro.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("id="+id+"&cedula="+cedula+"&nombre="+nombre+"&edad="+edad+"&sexo="+sexo+"&telefono="+telefono+"&correo="+correo+"&direccion="+direccion+"&establecimiento="+establecimiento+"&sector="+sector+"&loggin="+loggin+"&password="+password);
		var divregistro=document.getElementById("registro");
		ajax.onreadystatechange=function()
		{
			if (ajax.readyState==4)
...
function activarUsuario(){
	var ajax=nuevoAjax();
	var id=document.getElementById("formulario").idmedico.value;
	ajax.open("POST","activarUsuario.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("id="+id);
	ajax.onreadystatechange=function()
	{
...
function desactivarUsuario(){
	var ajax=nuevoAjax();
	var id=document.getElementById("formulario").idmedico.value;
	ajax.open("POST","desactivarUsuario.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("id="+id);
	ajax.onreadystatechange=function()
	{
